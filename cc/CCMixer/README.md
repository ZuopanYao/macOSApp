...
CCMixer创建文件示例(实现文件)
![](./image/2978580583.jpg)
`不要怀疑，这真不是人写的，这真不是人写的，这真不是人写的`

CCMixer添加垃圾代码示例(实现文件)
![](./image/2185348302.jpg)
`不要怀疑，这真不是人写的，这真不是人写的，这真不是人写的`

## CCMixer三大功能
### 1、混淆
向项目添加混淆/垃圾代码
![](./image/Snip20190829_5.png)
